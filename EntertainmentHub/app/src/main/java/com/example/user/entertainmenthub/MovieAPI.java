...
public class MovieAPI extends AppCompatActivity implements  MoviePosterGridFragment.OnMovieSelectedListener {

    static final String TAG = MovieAPI.class.getSimpleName();
