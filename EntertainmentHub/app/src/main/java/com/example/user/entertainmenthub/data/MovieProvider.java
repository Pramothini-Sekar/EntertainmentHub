package com.example.user.entertainmenthub.data;
...
import com.example.user.entertainmenthub.data.MovieContract.MovieEntry;
import com.example.user.entertainmenthub.data.MovieContract.MovieGenreEntry;
